...
export const MOCK_MESSAGES = {
  'comm-1': [
    ...
    { id: 'msg-13', sender_id: 'user-admin-1', sender_name: 'Pieter Janssens', sender_avatar: null, content: 'Reminder: general assembly this Thursday at 19h in Aula Pieter De Somer', created_at: h(0.5) },
  ],
  'comm-2': [
  ...
  'comm-3': [
    ...
    { id: 'msg-39', sender_id: 'user-22', sender_name: 'Chiara Rossi', sender_avatar: null, content: 'Does anyone know a good dentist that takes RIZIV?', created_at: h(6) },
  ],
  'sub-1': [
